...
class GleeRouter {
   ...
   * @private
   */
  private _addMiddlewares (target:GenericChannelMiddlewareTuple[], middlewares:GenericChannelMiddlewareTuple[], channel:string) {
   ...
   * @param {String} [channel] The scope channel.
   */
  addOutboundMiddlewares (middlewares:ChannelMiddlewareTuple[], channel?:string) {
   ...
   * @param {String} [channel] The scope channel.
   */
  addErrorMiddlewares(errorMiddlewares:ChannelErrorMiddlewareTuple[], channel?:string) {
   ...
   * @param {String} [channel] The scope channel.
   */
  addOutboundErrorMiddlewares (errorMiddlewares:ChannelErrorMiddlewareTuple[], channel?:string) {
