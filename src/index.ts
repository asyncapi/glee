...
export default async function GleeAppInitializer() {
  ...
  //edited
  // app.use(
  //   authMiddleware(parsedAsyncAPI, { GLEE_AUTH_DIR, runAuth, registerAuth })
  // );
  // app.useOutbound(
  //   authMiddleware(parsedAsyncAPI, {
  //     GLEE_AUTH_DIR,
  //     runAuth,
  //     registerAuth,
  //     app,
  ...
  // const responses = await runAuth("tokens", {
  //   glee: app,
  ...
  app.on("adapter:auth", (e: EnrichedEvent) => {
    logLineWithIcon(
      ":zap:",
