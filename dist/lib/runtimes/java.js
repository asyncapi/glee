...
export function generateAndStartServer(asyncapiFilePath, runtime) {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            console.error(e); /* We did our best... */
        }
        try {
            ...
            await Promise.all([...runtime.files].map(filePath => (copyFile(filePath, path.resolve(generatedPath, 'src/main/java/glee/functions', basename(filePath))))));
